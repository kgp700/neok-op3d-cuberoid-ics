...
//LGE_CHANGE_S [mo2hongkun.kim@lge.com] 2012-01-02, CTS Fail fix
static DEVICE_ATTR(keylock, 0665, keypad_keylock_show, keypad_keylock_store);
//LGE_CHANGE_E [mo2hongkun.kim@lge.com] 2012-01-02, CTS Fail fix
//LGE_E 11.12.13 <ntdeaewan.choi@lge.com> AT%KEYLOCK touch,keytouch,key disable
#endif
