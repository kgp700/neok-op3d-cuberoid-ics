...
#define CONFIG_MACH_LGE_CX2_TEMP //nthyunjin.yang 120424 for CX2 project temp source
...
#ifdef CONFIG_MACH_LGE_CX2_TEMP //nthyunjin.yang 120412
...
TWL6030_REGULATOR_DEVICE(vaux2, 2800000, 2800000, 0, 0);	// TWL_LDO_2.8V
TWL6030_REGULATOR_DEVICE(vaux3, 1800000, 1800000, 0, 0);	// TWL_DO_1.8V
#else
