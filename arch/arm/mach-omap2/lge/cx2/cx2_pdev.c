...
//---
#if CONFIG_MACH_LGE_CX2_SU870 //##hwcho_20120416
#include <plat/keypad.h>
#endif

#if CONFIG_MACH_LGE_CX2_SU870 //nthyunjin.yang 120412
...
static struct key_table gkpd_keys[] = {
	{'D', KEY_VOLUMEDOWN},
	{'U', KEY_VOLUMEUP},
#if defined(CONFIG_MACH_LGE_CX2_SU870)//hw2002.cho
	{'F', KEY_3D},
#else
	{'F', KEY_CAPTURE},
#endif //##
...
int __init p720_pdevs_init(void)
{
	 ...
	 */
#ifdef CONFIG_MACH_LGE_CX2_SU870
