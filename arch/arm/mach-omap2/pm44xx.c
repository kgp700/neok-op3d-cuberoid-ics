...
{
#ifdef CONFIG_MACH_LGE_CX2 //LAST POWER OFF REASON
	int ret=0;
...
#ifdef CONFIG_MACH_LGE_CX2 //nthyunjin.yang 120616 for power off issue in entering sleep by CX2 GB MR 6th version.
	//VUSB
